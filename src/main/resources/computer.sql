...
INSERT INTO computer_accessories(Type_id,Component_name,capacity,price) VALUES(5,'三星孤星17寸显示器',DEFAULT,666);	
SELECT * FROM computer_accessories;
SELECT  computer_accessories.*,computer_type.`typename` FROM computer_accessories,computer_type WHERE  computer_type.Type_id=computer_accessories.`Type_id` 
...
SELECT computer_accessories.* FROM computer_accessories,coumpetrs WHERE computer_accessories.`component_id`=coumpetrs.`memory`  
